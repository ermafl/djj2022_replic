...
cap log close 
log using "${mytables}/main_tables.log", replace
...
***************************************
*Limit number of bootstrap replication*
***************************************
...
esttab using "${mytables}/table2.tex", replace ///
	keep(B_treat _cons) ///
...
//Tabulate
esttab, keep(B_treat highsd_std treat_highsd_std _cons) ///
...
esttab using "${mytables}/table3.tex", replace ///	
	keep(B_treat highsd_std treat_highsd_std _cons) ///
...
esttab using "${mytables}/table4.tex", replace ///
	keep(B_treat _cons) ///
	label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none)	 ///
	$preheader ///
...
next_seed
mhtreg ///
		    (E_Sgender_index2      B_treat treat_Pgender_index2 B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_*)) ///
			(E_Saspiration_index2  B_treat treat_Pgender_index2 B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6      c.B_Pgender_index2#c.(B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6     )) ///
			(E_Sbehavior_index2    B_treat treat_Pgender_index2 B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_*)) ///
			, cluster(Sschool_id) cltype(3) seed(${seed}) robust $mhtreg_bootstrap
store_mht_se, varname(B_treat) matname(B_treat)			
			
next_seed	
mhtreg ///
		    (E_Sgender_index2      treat_Pgender_index2 B_treat B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_*)) ///
			(E_Saspiration_index2  treat_Pgender_index2 B_treat  B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6      c.B_Pgender_index2#c.(B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6     )) ///
			(E_Sbehavior_index2    treat_Pgender_index2 B_treat B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_*)) ///
			, cluster(Sschool_id) cltype(3) seed(${seed}) robust $mhtreg_bootstrap
...
next_seed
randcmd ///
			((B_treat) reg E_Sgender_index2      B_treat treat_Pgender_index2 B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_*), cluster(Sschool_id)) ///
			((B_treat) reg E_Saspiration_index2  B_treat treat_Pgender_index2 B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6      c.B_Pgender_index2#c.(B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6     ), cluster(Sschool_id)) ///
			((B_treat) reg E_Sbehavior_index2    B_treat treat_Pgender_index2 B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_*), cluster(Sschool_id)) ///
			, treatvars(B_treat) groupvar(Sschool_id) seed(${seed}) $randcmd_bootstrap
global tmp = e(REqn)[4,3]	
myround, global(tmp)	
loc joint_pval1 "$tmp_val"
...
next_seed
randcmd ///
			((treat_Pgender_index2) reg E_Sgender_index2      B_treat treat_Pgender_index2 B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sgender_index2     $el_gender_flag          district_gender_* gender_grade_*), cluster(Sschool_id)) ///
			((treat_Pgender_index2) reg E_Saspiration_index2  B_treat treat_Pgender_index2 B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6      c.B_Pgender_index2#c.(B_Saspiration_index2 $el_aspiration_flag      district_?        B_Sgrade6     ), cluster(Sschool_id)) ///
			((treat_Pgender_index2) reg E_Sbehavior_index2    B_treat treat_Pgender_index2 B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_* c.B_Pgender_index2#c.(B_Sbehavior_index2   $el_behavior_common_flag district_gender_* gender_grade_*), cluster(Sschool_id)) ///
			, treatvars(B_treat) groupvar(Sschool_id) seed(${seed}) $randcmd_bootstrap
global tmp = e(REqn)[4,3]	
myround, global(tmp)	
loc joint_pval2 "$tmp_val"
...
estimates clear
eststo: qui reg E_Sgender_index2  B_treat treat_Pgender_index2 ///
...
eststo: qui reg E_Saspiration_index2  B_treat treat_Pgender_index2 /// girls only
...
eststo: qui reg E_Sbehavior_index2  B_treat treat_Pgender_index2 ///
...
//Tabulate
esttab, keep(B_treat treat_Pgender_index2 _cons) ///
...
esttab using "${mytables}/table5.tex", replace ///
	keep(B_treat treat_Pgender_index2 _cons) ///
...
esttab b?, keep(B_treat _cons) ///
	label stats(control_group_mean N r2 pval_joint_hypothesis, fmt(${fmt} %9.0fc ${fmt}) label("Control group mean" "Number of students" "R2" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  nonumbers collabels(none)	

esttab b?_corrected, keep(B_treat _cons) ///
...
esttab g? using "${mytables}/table6_girls.tex", replace ///
	keep(B_treat _cons) ///
	label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none) ///
	$preheader ///
...
esttab b?  using "${mytables}/table6_boys.tex", replace ///
	keep(B_treat _cons) ///
	label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none)	///
	$preheader ///
...
esttab b?_corrected  using "${mytables}/table6_boys_corrected.tex", replace ///
	keep(B_treat _cons) ///
...
esttab g? using "${mytables}/table7_girls.tex", replace ///	
	keep(B_treat _cons) ///
...
esttab b? using "${mytables}/table7_boys.tex", replace ///	
	keep(B_treat _cons) ///
	p label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none) ///
	$preheader ///
...
esttab using "${mytables}/table8.tex", replace ///	
	keep(B_treat _cons) ///
	p label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none)	///
 	$preheader ///
...
esttab using "${mytables}/table9.tex", replace ///
	keep(B_treat highsd_std treat_highsd_std _cons) ///
...
esttab g1 b1 g2 b2 g3 b3, keep(B_treat _cons) ///
...
esttab g1 b1 g2 b2 g3 b3 using "${mytables}/table10.tex", replace ///	
	keep(B_treat _cons) ///
...
estimates clear
eststo: reg E2_Sscholar_index2 B_treat B_Saspiration_index2 treat_aspiration_index2 ///
...
eststo: reg E2_Sscholar_index2 B_treat B_Saspiration_index2_abm treat_aspiration_index2_abm ///
...
eststo: reg E2_Sscholar_index2 B_treat B_Sdisc_edu_goals treat_disc_edu_goals ///
...
esttab, keep(B_treat  treat_aspiration_index2 treat_aspiration_index2_abm treat_disc_edu_goals _cons) ///
...
esttab using "${mytables}/table11.tex", replace ///
	keep(B_treat  treat_aspiration_index2 treat_aspiration_index2_abm treat_disc_edu_goals  _cons) ///
...
esttab g? using "${mytables}/table12_girls.tex", replace ///
	keep(B_treat _cons) ///
	label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) 				    label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none) ///
	$preheader 	///
...
esttab g?_corrected using "${mytables}/table12_girls_corrected.tex", replace ///
	keep(B_treat _cons) ///
	label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) 				    label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none)	///
	$preheader 	///
...
esttab b? using "${mytables}/table12_boys.tex", replace ///
	keep(B_treat _cons) ///
	label stats(/*control_group_mean*/ N r2 pval_joint_hypothesis, fmt(/*${fmt}*/ %9.0fc ${fmt}) 				    label(/*"Control group mean"*/ "Number of students" "\$R^2$" "P-value, joint hypothesis" )) ///
	cells(b(fmt(${decimals})) ${p_se}(fmt(${decimals}) par) robust_p(fmt(${decimals}) par(`"["' `"]"')))  /*nonumbers*/ collabels(none)	///
	$preheader 	///
